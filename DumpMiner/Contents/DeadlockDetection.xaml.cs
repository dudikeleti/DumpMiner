...
{
    [OperationView("/OperationTypes/DeadlockDetection", "Deadlock Detection")]
    public partial class DeadlockDetection : IContent, IHasViewModel
    {
        public DeadlockDetection()
        {
            InitializeComponent();
            ExtendedData = new Dictionary<string, object> {["OperationName"] = OperationNames.DeadlockDetection};
        }
