...
{
    [OperationView("/OperationTypes/DumpObject", "Dump Object")]
    public partial class DumpObject : IContent, IHasViewModel
    {
        private const string SizeText = "Selected object size is: {0}";
        public DumpObject()
        {
            InitializeComponent();
            ExtendedData = new Dictionary<string, object> {["OperationName"] = OperationNames.DumpObject};
