...
{
    [OperationView("/OperationTypes/DumpComparison", "Dump Comparison")]
    public partial class DumpComparison : IContent, IHasViewModel
    {
        public DumpComparison()
        {
            InitializeComponent();
            ExtendedData = new Dictionary<string, object> {["OperationName"] = OperationNames.DumpComparison};
        }
